...
No alt-tabbing. No searching manually. <BR>Everything appears exactly when you need it.
...
| Example | Description |
|---|---|
| ![Preview 1](./media/preview1.png) | Fast in-game examination |
| ![Preview 2](./media/preview2.png) | Detailed information panels |
| ![Preview 3](./media/preview3.png) | Smooth companion interface |
